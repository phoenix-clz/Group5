...
const WalletPage = () => {
  ...
  const pieChartData = useMemo(() => {
    return {
      labels: wallets.filter((wallet) => wallet.linked).map((wallet) => wallet.name),
      datasets: [
        {
          data: wallets.filter((wallet) => wallet.linked).map((wallet) => wallet.balance),
          backgroundColor: [
            "#FF6384",
            "#36A2EB",
            "#FFCE56",
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="container p-4 mx-auto">
              ...
              {wallets.map((wallet) => (
                <div key={wallet.id} className="p-4 bg-white rounded-lg shadow">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => toggleWalletLink(wallet.id, wallet.linked)}
          ...
          <div className="grid grid-cols-1 gap-8 mb-8 md:grid-cols-2">
            <div>
              <h2 className="mb-4 text-2xl font-bold">Wallet Distribution</h2>
