...
const HeroSection = ({ handleLogin }) => {
  return (
    <section
      className="relative px-4 flex flex-col items-center justify-center h-screen pt-20 bg-blue-200"
      style={{
    ...
    >
      ...
      <FadeIn direction="down">
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold text-white z-10 text-center">
          Take Control of Your Finances
        </h1>
      </FadeIn>
      <FadeIn direction="right">
        <p className="mt-4 text-md sm:text-xl md:text-2xl text-white z-10 text-center">
